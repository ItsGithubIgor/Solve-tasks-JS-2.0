...
function t9() {
let i9Val = i9.value;
document.querySelector('.out-9').textContent = i9Val;
i9.value = '';
}
...
function t10() {
let i10Val = i10.value;
document.querySelector('.out-10').textContent = +i10Val * 10;
}
...
function t11() {
let i11Val = i11.value;
document.querySelector('.out-11').textContent = +i11Val + 10;
}
...
function t12() {
let i121Val = i121.value;
let i122Val = i122.value;

document.querySelector('.out-12').textContent = 'Привет ' + i121Val + ' ' + i122Val;
}
...
function t13() {
let i131Val = i131.value;
let i132Val = i132.value;

document.querySelector('.out-13').textContent = +i131Val + +i132Val;
}
...
function t16() {
let i161Val = i161.value;
let i162Val = i162.value;

document.querySelector('.out-16').textContent = +i161Val + +i162Val;
}
...
function t19() {
let i191Val = i191.value;
let i192Val = i192.value;

document.querySelector('.out-19').textContent = +i191Val + +i192Val;
}
...
let i21v = document.querySelector('.i-20-1');
let i22v = document.querySelector('.i-20-2');
let i23v = document.querySelector('.i-20-3');
let i24v = document.querySelector('.i-20-4');
...
function t20() {
    ...
    i23 = i23v.value;
    i24 = i24v.value;
    document.querySelector('.out-20').innerHTML  = 'Уважаемый ' + i21 + ', ' + i22 + ', ваш возраст ' + i23 + ', по проффессии вы ' + i24;
}
